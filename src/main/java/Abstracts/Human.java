...
public class Human {
    ...
    public Human(String name, String surname, String birthDate, int iq){
        ...
        this.setBirthDate(stringDateParser(birthDate));
        this.setIq(iq);
    }
    public Human(String name, String surname, String  birthDate, int iq, Map<DayOfWeeks, String> schedule, Family family) {
        this.setName(name);
        this.setSurname(surname);
        this.setBirthDate(stringDateParser(birthDate));
        this.setIq(iq);
    ...
    public long stringDateParser(String date){
